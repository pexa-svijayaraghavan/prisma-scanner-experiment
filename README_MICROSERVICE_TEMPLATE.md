...
- [staging](https://<api_name>.staging.cloud.pexa.com.au/health)
- [prod](https://<api_name>.cloud.pexa.com.au/health)
...
- [staging](https://pexa.splunkcloud.com/en-US/app/search/search?q=<query>)
- [prod](https://pexa.splunkcloud.com/en-US/app/search/search?q=<query>)

### Pagerduty

Alarms is sent to [Team Business Hours](https://pexa.pagerduty.com/services/<id>)
